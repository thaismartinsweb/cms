<div class="panel">
	<form class="form-horizontal" method="post" action="<?php echo base_url() ?><?php echo $controller ?>/save" enctype="multipart/form-data">
		...
		<div class="control-group">
			<label class="control-label">Tútulo do Conteúdo</label>
			<div class="controls">
				<input type="text" placeholder="Tútulo do Conteúdo" name="title" value="<?php echo isset($base['title']) ? $base['title'] : '';?>" class="bg-focus input-xlarge">
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<div class="checkbox">
					<label><input type="checkbox" name="published" value="1" <?php echo isset($base['published']) && $base['published'] == 1 ?'checked':'';?>> Exibir este Conteúdo no Site</label>
				</div>
			</div>
		</div>
